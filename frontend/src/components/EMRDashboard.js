...
const EMRDashboard = () => {
  ...
  const AUTH_TOKEN =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UlDa4g9DxeqsVI2hI5HYVIV7lwZLIN2dU2p0j9NXLTw";
  const CSRF_TOKEN_APPOINTMENTS =
    "5bWdtUN3Zi1qvHgJJAPKbaUXc6pHqkltRtSDUFe7tZx58x7Lu0PVYMMWRg9PeH9W";
  const CSRF_TOKEN =
    "yHk1nRM73CJqVHFD3jXHGtP7lGZpUkS5kZgrOCdbxjf5yxwFOJXSt5H60QJxIHGy";
      ...
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          ...
          if (response.data.length > 0) {
            setSelectedProvider(
              response.data[0].id || response.data[0].name || response.data[0]
            );
          }
        }
        setSnackbar({
  ...
  const handleProviderChange = (event) => {
    ...
    setSnackbar({
      open: true,
      message: `Provider changed to ${event.target.value}`,
      severity: "info",
    });
  };
  ...
  const createAppointment = async () => {
    ...
    try {
      ...
      const newAppt = {
        ...
        contact: "TBD",
        provider:
          providers.find((p) => p.id === newAppointment.provider_id)?.name ||
          "Unknown",
      ...
      case 0:
        return (
          <Box sx={{ p: 4, textAlign: "center" }}>
            <Typography variant="h4" sx={{ mb: 2, color: "#2c5aa0" }}>
              Dashboard
            </Typography>
            <Typography variant="body1" color="text.secondary">
              Welcome to the EMR Dashboard. Select a tab to view different
              sections.
            </Typography>
          </Box>
        );
        ...
        return (
          ...
          >
            ...
            >
              <Typography
                variant="h6"
                sx={{ color: "white", fontWeight: "bold", minWidth: "80px" }}
              >
                Provider
              </Typography>
                      ...
                      >
                        ...
                        >
                          ...
                          <TextField
                            ...
                            onChange={(e) =>
                              updateWeekDay(index, "from", e.target.value)
                            }
                            sx={{
                              minWidth: "100px",
                          ...
                          <TextField
                            ...
                            disabled={!dayData.enabled}
                            onChange={(e) =>
                              updateWeekDay(index, "till", e.target.value)
                            }
                            sx={{
                              minWidth: "100px",
                              "& .MuiInputBase-input": { fontSize: "14px" },
                ...
                <Grid item xs={12} md={6}>
                  ...
                  >
                    ...
                    >
                      <Typography
                        variant="body1"
                        sx={{ mb: 2, fontWeight: "medium", color: "#374151" }}
                      >
                      ...
                      <FormControl fullWidth size="medium">
                        ...
                        >
                          <MenuItem value="UTC-05:00">
                            Eastern Standard Time (EST)
                          </MenuItem>
                          <MenuItem value="UTC-08:00">
                            Pacific Standard Time (PST)
                          </MenuItem>
                          <MenuItem value="UTC-06:00">
                            Central Standard Time (CST)
                          </MenuItem>
                          <MenuItem value="UTC-07:00">
                            Mountain Standard Time (MST)
                          </MenuItem>
                          <MenuItem value="UTC+00:00">
                    ...
                    >
                      <Typography
                        variant="body1"
                        sx={{ mb: 3, fontWeight: "medium", color: "#374151" }}
                      >
                          ...
                          <Grid container spacing={2} alignItems="center">
                            <Grid item xs={12} sm={4}>
                              <TextField
                                ...
                                value={blockDay.date}
                                onChange={(e) =>
                                  updateBlockDay(index, "date", e.target.value)
                                }
                                sx={{
                                  "& .MuiInputBase-input": { fontSize: "14px" },
                                }}
      ...
      <AppBar position="static" sx={{ bgcolor: "#2c5aa0", boxShadow: "none" }}>
        <Toolbar sx={{ minHeight: "56px !important" }}>
          <Typography
            variant="h6"
            component="div"
            sx={{ flexGrow: 0, mr: 4, fontSize: "16px" }}
          >
            EMR
          </Typography>
            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("patient_id", e.target.value)
                  }
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    label="Provider"
                    onChange={(e) =>
                      updateAppointmentField("provider_id", e.target.value)
                    }
                  >
                    {providers.map((provider) => (
                      <MenuItem
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("appointment_date", e.target.value)
                  }
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("appointment_time", e.target.value)
                  }
                  InputLabelProps={{ shrink: true }}
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <RadioGroup
                    ...
                    onChange={(e) =>
                      updateAppointmentField("appointment_mode", e.target.value)
                    }
                    row
                  >
                    <FormControlLabel
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("timezone", e.target.value)
                  }
                />
              </Grid>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("reason_for_visit", e.target.value)
                  }
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("symptoms", e.target.value)
                  }
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  onChange={(e) =>
                    updateAppointmentField("estimated_amount", e.target.value)
                  }
                  placeholder="120.00"
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    label="Currency"
                    onChange={(e) =>
                      updateAppointmentField("currency", e.target.value)
                    }
                  >
              ...
              {newAppointment.appointment_mode === "video_call" && (
                <Grid item xs={12}>
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      updateAppointmentField("video_call_link", e.target.value)
                    }
