  ...
  const sidebar = (
    ...
    >
      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
        <Chip
          label="Available"
          sx={{ bgcolor: STATUS_COLORS.available, color: "#fff" }}
          size="small"
        />
        <Chip
          label="Booked"
          sx={{ bgcolor: STATUS_COLORS.booked, color: "#fff" }}
          size="small"
        />
        <Chip
          label="Blocked"
          sx={{ bgcolor: STATUS_COLORS.blocked, color: "#fff" }}
          size="small"
        />
        <Chip
          label="Pending"
          sx={{ bgcolor: STATUS_COLORS.pending, color: "#fff" }}
          size="small"
        />
        <Chip
          label="Break"
          sx={{ bgcolor: STATUS_COLORS.break, color: "#fff" }}
          size="small"
        />
      </Box>
      <Divider sx={{ my: 2 }} />
  ...
  const calendarHeader = (
    ...
    >
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
        ...
        <Button size="small" sx={{ ml: 2 }} startIcon={<CalendarToday />}>
          Today
        </Button>
      </Box>
      <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
      ...
      {mockSlots.map((slot) => (
        <Grid item xs={12} sm={6} md={4} key={slot.id}>
          <Card
            sx={{
              p: 2,
              bgcolor: STATUS_COLORS[slot.status],
              color: "#fff",
              position: "relative",
            }}
          >
